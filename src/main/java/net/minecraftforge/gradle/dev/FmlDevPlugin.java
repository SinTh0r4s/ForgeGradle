...
public class FmlDevPlugin extends DevBasePlugin {
    ...
    private void createMiscTasks() {
        ...
        {
            task.setLibsFromProject(delayedFile(DevConstants.ECLIPSE_FML + "/build.gradle"), "implementation", true);
    ...
    private void createPackageTasks() {
        ...
        {
            range.setLibsFromProject(delayedFile(DevConstants.ECLIPSE_FML + "/build.gradle"), "implementation", true);
