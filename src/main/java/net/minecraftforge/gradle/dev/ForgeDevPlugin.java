...
public class ForgeDevPlugin extends DevBasePlugin {
    ...
    private void createMiscTasks() {
        ...
        {
            extractRange.setLibsFromProject(delayedFile(ECLIPSE_FORGE + "/build.gradle"), "implementation", true);
        ...
        {
            extractRange.setLibsFromProject(delayedFile(ECLIPSE_CLEAN + "/build.gradle"), "implementation", true);
    ...
    private void createPackageTasks() {
        ...
        {
            range.setLibsFromProject(delayedFile(DevConstants.ECLIPSE_FORGE + "/build.gradle"), "implementation", true);
